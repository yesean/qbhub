...
const acceptableAnswerlines = [
  ...
  {
    answerline: 'convergence [or word forms such as convergent sequence; accept dominated convergence theorem or uniform convergence or pointwise convergence]',
    answers: [
      'convergence',
  ...
  {
    answerline: 'Princes in the Tower [accept Edward V and Richard of Shrewsbury, Duke of York; accept any answer referring to the two princes possibly murdered by Richard III in the Tower of London] <LC>',
    answers: [
  ...
  {
    answerline: 'william [or william the conqueror; or william the bastard; or william i the bad; or william ii the good]',
    answers: [
      'william',
  ...
  {
    answerline: 'John Dos Passos [or John Roderigo Dos Passos; do not accept or prompt on "Passos"]',
    answers: [
      'john dos passos',
  ...
  {
    answerline: 'knowledge [do not prompt or accept "belief"; prompt on justified true belief]',
    answers: ['knowledge'],
  },
  {
    answerline: 'pharmaceutical industry [or prescription drug industry; accept answers mentioning pharmaceuticals or prescription drugs or prescription medications such as drug companies or pharma; prompt on answers mentioning “healthcare” or “medical” or “pharmacies” or similar terms]',
    answers: [
...
const promptableAnswerlines = [
  {
    answerline: 'Sicilian Expedition [accept answers involving Athens\'s naval voyage to Sicily for military purposes; prompt on Siege of Syracuse before "Syracuse" is read; prompt on Peloponnesian War before "Segesta" is read]',
  ...
  {
    answerline: 'security vulnerabilities [or exploits or security bugs or security holes; accept zero-days until read; prompt on bugs, issues, weaknesses, defects, flaws, anomalies, threats, attacks, cyberattacks, breaches, or hacks by asking “what general impact do they have?” and accept answers like “weakens security” or “vulnerable to attack”; prompt on specific types of bugs, such as software bugs or buffer over-read or memory leaks, by asking “can you be less specific?”; do not accept or prompt on “glitches” or “viruses” or “malware” or “data breaches”]',
    answers: ['bugs', 'specific types of bugs'],
  },
  {
    answerline: 'denial of the Armenian Genocide [or equivalents saying that Turkey does not acknowledge that Armenian Genocide really happened; accept answers like Turkey not calling the Armenian Genocide a genocide; answers must include the phrase Armenian Genocide and that its veracity is being denied; prompt on simply genocide denialism; do not accept or prompt on Holocaust denial; do not accept or prompt on answers from Turkish ultranationalists like "lies about the Armenian incident" or whatever]',
